...
def get_universe():
    """Combined NASDAQ-100 + S&P 500 universe, deduplicated, sorted."""
    combined = dict.fromkeys(get_ndx100() + get_sp500())
...
def main():
    ...
    output = {
        ...
        'config': {'lookbackYears': LOOKBACK_YEARS, 'holdDays': HOLD_DAYS, 'universe': 'NASDAQ-100 + S&P 500'},
